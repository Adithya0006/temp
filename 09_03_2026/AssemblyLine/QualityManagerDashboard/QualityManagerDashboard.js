...
import MRLExipryTable from "./MRLExipryTable";
...
const card = [
    {
      text: "Manage Operator MRL", // Text displayed on the card
      description: "Define MRL Level on Expiry", // Description displayed on the card
      icon: <GroupAddIcon fontSize="large"  sx={{ fontSize: 60, color: "#6366f1" }}/>, // Icon for the card
      component: <MRLExipryTable></MRLExipryTable>, // The component to render when the card is clicked
...
function QualityManagerDashboard(){
           ...
           {selectedView ? (
             <>
                    ...
                    {/* <Button  onClick={handleBackToHome}   > */}
                       <ArrowBackIosNewIcon  onClick={handleBackToHome} sx={{ fontSize: '1.2rem',cursor:"pointer" }} />
                   {/* </Button> */}
            ...
            //  <IconButton edge="start" color="primary" sx={{ mr: 2, cursor: 'default' }} />
             ...
             <HomeIcon  sx={{cursor:"pointer"}} ></HomeIcon>
           )}
